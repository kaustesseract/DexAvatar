...
def parse_config(argv=None):
    ...
    parser.add_argument('--sign_class',
                        required=True, help='sign class file path')
    parser.add_argument('--sign_segment',
                        required=True, help='sign segment file path')
    ...
    parser.add_argument('--use_hposer3d', default=False,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='Use the VAE pose embedding')
    parser.add_argument('--signhposer_dir', required=True, is_config_file=True,
                        help='config file path')
    ...
    parser.add_argument('--model_type', default='smpl', type=str,
                        ...
                        ' data.')
    parser.add_argument('--signbposer_dir', default='', type=str,
                        help='The folder where the body prior is stored')
    ...
    parser.add_argument('--jaw_prior_type', default='l2', type=str,
                        ...
                        ' regularize the optimization of the pose of the' +
                        ' jaw.')
    parser.add_argument('--use_signbposer', default=False,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='Use the VAE pose embedding')
    ...
    parser.add_argument('--data_3d_weights', nargs='*',
                        default=[0, ] * 5, type=float,
                        help='The weight of the data term')
    parser.add_argument('--data_init_core_weights', nargs='*',
                        default=[0, ] * 5, type=float,
                        help='The weight of the data term')
    parser.add_argument('--data_init_noncore_weights', nargs='*',
                        default=[0, ] * 5, type=float,
                        help='The weight of the data term')
    parser.add_argument('--data_init_lhand_weights', nargs='*',
                        default=[0, ] * 5, type=float,
                        help='The weight of the data term')
    parser.add_argument('--data_init_rhand_weights', nargs='*',
                        default=[0, ] * 5, type=float,
                        help='The weight of the data term')
    ...
    parser.add_argument('--body_biomechanics_loss_weights',
                        default=[0.0, 0.0, 0.0, 2.0], type=float,
                        nargs='*',
                        help='The weights for the body biomechanics loss' +
                        ' for each stage of the optimization')
    parser.add_argument('--hand_joints_weights',
                        default=[0.0, 0.0, 0.0, 2.0],
                        type=float, nargs='*',
                        help='The weights for the 2D joint error of the hands')
    parser.add_argument('--body_joints_weights',
                        default=[0.0, 0.0, 0.0, 2.0],
                        type=float, nargs='*',
                        help='The weights for the 2D joint error of the bodys')
    parser.add_argument('--split_num',
                        default=1,
                        type=float,
                        help='total job split number')
    parser.add_argument('--cur_num',
                        default=0,
                        type=float,
                        help='cur job split number')
